...
class ParallelCompareWithUrl:
    ...
    def compare(self):
        ...
        elapsed_time_list_for_async.append(self._execute_by_async_with_log());
        elapsed_time_list_for_threading.append(self._execute_by_threading_with_log());
        elapsed_time_list_for_multiprocessing.append(self._execute_by_multiprocessing_with_log());
    ...
    def _execute_by_threading_with_log(self):
        start_time = time.time()
        self._execute_by_threading()
        return time.time() - start_time

    def _execute_by_async_with_log(self):
        start_time = time.time()
        asyncio.run(self._execute_by_async())
        return time.time() - start_time

    def _execute_by_multiprocessing_with_log(self):
        start_time = time.time()
